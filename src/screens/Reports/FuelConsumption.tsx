...
export default function FuelConsumption() {
  ...
  const VehicleMovingTrackStatusdetnew = (dateFrom1:any, dateTo1:any, isChecked:any, vNO:any, vType:any) => {
    const url = 'http://103.12.1.132:8166/api/VehicleMoving/VehicleFuelConsumenew';
  ...
  const handleShow = () => {
    ...
    navigation.navigate('Showfuelconsp',requestBody); 
  };

  return (
    <View style={styles.container}>
      <ActionBar title="Fuel Consumption" containerStyle={{ backgroundColor: colors.red.DASHBOARD_HEADER_BACKGROUND }} />

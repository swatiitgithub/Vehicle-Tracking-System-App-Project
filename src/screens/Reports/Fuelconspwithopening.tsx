...
export default function FuelConspwithopening() {
  ...
  const VehicleMovingTrackStatusdetnew = (dateFrom1:any, dateTo1:any, isChecked:any, vNO:any, vType:any) => {
    const url = 'http://103.12.1.132:8166/api/VehicleMoving/VehicleDetailSummarynew';
  ...
  const handleShow = () => {
    ...
    navigation.navigate('Showfuelwithopening',requestBody); 
  };

  return (
    <View style={styles.container}>
      <ActionBar title="Fuel Consp with Opening" containerStyle={{ backgroundColor: colors.red.DASHBOARD_HEADER_BACKGROUND }} />

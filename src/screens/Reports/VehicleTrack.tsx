...
export default function VehicleTrack() {
  ...
  const handleShow = () => {
    ...
    // console.log(JSON.stringify(requestBody,null,1))
    navigation.navigate('Showvehicletrack',requestBody); 
    
  };

  return (
    <View style={styles.container}>
      <ActionBar title="Vehicle Track" containerStyle={{ backgroundColor: colors.red.DASHBOARD_HEADER_BACKGROUND }} />

...
export default function Vehhicledetailssummary() {
  ...
  useEffect(() => {
    ...
    fetchVehicleType();
    getPeriod();
  }, [dateFrom, dateTo, isChecked, vNO, vType]);
  ...
  const VehicleMovingTrackStatusdetnew = (dateFrom1:any, dateTo1:any, isChecked:any, vNO:any, vType:any) => {
      //  axiosRequest(Url.Vehicledetails, Constant.API_REQUEST_METHOD.POST)
       console.log("==========",Url.Vehicledetails);
  ...
  const handleShow = () => {
    ...
    navigation.navigate('ShowVehicledetailssummary',requestBody);
  };

  return (
    <View style={styles.container}>
      <ActionBar title="Vehicle Details Summary" containerStyle={{ backgroundColor: colors.red.DASHBOARD_HEADER_BACKGROUND }} />

...
export default function Probablewithtemp() {
  ...
  useEffect(() => {
    VehicleMovingTrackStatusdetnew(dateFrom,dateTo,isChecked,vNO,vType,isCheck);
    fetchVehicleNumbers();
    fetchVehicleType();
    getPeriod();
  }, []);
  ...
  const VehicleMovingTrackStatusdetnew = (dateFrom1:any, dateTo1:any, isChecked:any, vNO:any, vType:any,isCheck:any) => {
  ...
  const handleShow = () => {
    ...
    ? selectedPeriod1.startDate
    : dateFrom;
    const endDate =
    selectedOption?.value === 'custom'
    ? selectedPeriod1.endDate
    : dateTo;
    console.log('Showing data...', dateFrom,dateTo,isChecked,vNO,vType,isCheck);
    
    const requestBody=VehicleMovingTrackStatusdetnew(dateFrom,dateTo,isChecked,vNO,vType,isCheck)
    navigation.navigate('Showprobablewire',requestBody); 
  };

  return (
    <View style={styles.container}>
      <ActionBar title="Probable with Tempering" containerStyle={{ backgroundColor: colors.red.DASHBOARD_HEADER_BACKGROUND }} />
      <View style={styles.content}>
         <View style={styles.checkboxContainer}>
                  ...
                  />
                  <Text style={styles.label}>Deactive Devices</Text>
                </View>
                ...
                <View style={styles.checkboxContainer}>
                  ...
                  />
                  <Text style={styles.label}>Wire Tempring</Text>
                </View>

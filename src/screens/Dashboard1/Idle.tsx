...
const Idle = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const url = 'https://vtsapi.mssplonline.in/api/NTRead/GetRunningStatus/stat=Idle';
  ...
  return (
    <View style={styles.container}>
     <ActionBar title="Idle Vehicle" containerStyle={{ backgroundColor: colors.red.DASHBOARD_HEADER_BACKGROUND }} />
      {/* Search bar */}
...
const styles = StyleSheet.create({
  ...
  cellColumn: {
    width: 120, // Match width of header columns
  },
  loaderContainer: {
    flex: 1,

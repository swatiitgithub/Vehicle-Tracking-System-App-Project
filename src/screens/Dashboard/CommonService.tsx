    ...
    return (
        <>
            <View>
                ...
                {Constant.COMMON_SERVICE_CENTER && Constant.COMMON_SERVICE_CENTER.map((item: any) => {
                    return (
                        <View>
                                    ...
                                    return (
                                            <View style={styles.servicesIconViewO}>
                                                <TouchableOpacity
                                                    ...
                                                    <FontAwesomeIcon name={subItem.catIcon ? subItem.catIcon : 'circle'} size={20} color={subItem.catIcon ? theme.colors.ICON_COLOR2 : "#dcdcdc"} />
